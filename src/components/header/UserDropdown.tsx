  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 p-2 text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
          <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">admin@shreeram.com</p>
          </div>
          <div className="py-1">
